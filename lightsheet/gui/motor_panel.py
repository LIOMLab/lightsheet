...
class MotorPanelWidget(QWidget):
    ...
    def updateUi_motor_buttons(self, disable_button: bool = True) -> None:
        ...
        buttons_to_disable = [
            self._shell.ui.pushButton_sampleStepUp,
            self._shell.ui.pushButton_sampleGotoOrigin,
            self._shell.ui.pushButton_sampleStepDown,
            self._shell.ui.pushButton_sampleStepBackward,
            self._shell.ui.pushButton_sampleStepForward,
            self._shell.ui.pushButton_sampleGotoHPosition,
            self._shell.ui.pushButton_sampleGotoVPosition,
            self._shell.ui.pushButton_cameraStepBackward,
            self._shell.ui.pushButton_cameraStepForward,
            # self._shell.ui.pushButton_cameraGotoFocus,
            self._shell.ui.pushButton_cameraGotoPosition,
        ]
    ...
    def updateUi_units(self) -> None:
        ...
        self._shell.ui.doubleSpinBox_sampleSetHPosition.setMaximum(
        ...
        self._shell.ui.doubleSpinBox_sampleSetVPosition.setMaximum(
        ...
        self._shell.ui.doubleSpinBox_cameraSetPosition.setMaximum(
            self._shell.motors.camera.get_limit_high(self._shell.units)
        )

        # Updates to horizontal step size (increment/decrement)
        self._shell.ui.doubleSpinBox_sampleHStepSize.setValue(self._shell.units_increment)
        self._shell.ui.doubleSpinBox_sampleHStepSize.setDecimals(self._shell.units_decimals)
        self._shell.ui.doubleSpinBox_sampleHStepSize.setSuffix(f" {self._shell.units}")
        self._shell.ui.doubleSpinBox_sampleHStepSize.setMinimum(10**-self._shell.units_decimals)
        maximum_horizontal_increment = (
            self._shell.ui.doubleSpinBox_sampleSetHPosition.maximum()
            - self._shell.ui.doubleSpinBox_sampleSetHPosition.minimum()
        )
        self._shell.ui.doubleSpinBox_sampleHStepSize.setMaximum(maximum_horizontal_increment)

        # Updates to vertical step size (increment/decrement)
        self._shell.ui.doubleSpinBox_sampleVStepSize.setValue(self._shell.units_increment)
        self._shell.ui.doubleSpinBox_sampleVStepSize.setDecimals(self._shell.units_decimals)
        self._shell.ui.doubleSpinBox_sampleVStepSize.setSuffix(f" {self._shell.units}")
        self._shell.ui.doubleSpinBox_sampleVStepSize.setMinimum(10**-self._shell.units_decimals)
        maximum_vertical_increment = (
            self._shell.ui.doubleSpinBox_sampleSetVPosition.maximum()
            - self._shell.ui.doubleSpinBox_sampleSetVPosition.minimum()
        )
        self._shell.ui.doubleSpinBox_sampleVStepSize.setMaximum(maximum_vertical_increment)

        # Updates to camera step size (increment/decrement)
        self._shell.ui.doubleSpinBox_cameraStepSize.setValue(self._shell.units_increment)
        self._shell.ui.doubleSpinBox_cameraStepSize.setDecimals(self._shell.units_decimals)
        self._shell.ui.doubleSpinBox_cameraStepSize.setSuffix(f" {self._shell.units}")
        self._shell.ui.doubleSpinBox_cameraStepSize.setMinimum(10**-self._shell.units_decimals)
        maximum_camera_increment = (
            self._shell.ui.doubleSpinBox_cameraSetPosition.maximum()
            - self._shell.ui.doubleSpinBox_cameraSetPosition.minimum()
        )
        self._shell.ui.doubleSpinBox_cameraStepSize.setMaximum(maximum_camera_increment)
    ...
    def updateUi_position_camera(self) -> None:
        ...
        self._shell.ui.label_cameraCurrentPosition.setText(self._shell.current_camera_position_text)
