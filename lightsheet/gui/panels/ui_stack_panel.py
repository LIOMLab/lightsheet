...
class Ui_StackPanel(object):
    def setupUi(self, stackPanel):
        ...
        self.verticalSpacer_7 = QSpacerItem(_s.LG + _s.XS, 1, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        ...
        self.pushButton_acqSetFirstPlane.setMinimumSize(QSize(_s.RAIL * 2 + _s.XL + _s.LG + _s.XS, _s.ZERO))
        ...
        self.doubleSpinBox_acqFirstPlane.setMinimumSize(QSize(_s.RAIL * 2 + _s.XL, _s.ZERO))
        ...
        self.pushButton_acqSetLastPlane.setMinimumSize(QSize(_s.RAIL * 2 + _s.XL + _s.LG + _s.XS, _s.ZERO))
        ...
        self.doubleSpinBox_acqLastPlane.setMinimumSize(QSize(_s.RAIL * 2 + _s.XL, _s.ZERO))
        ...
        self.label_stackPlanSummary.setMinimumSize(QSize(_s.ZERO, _s.RAIL + _s.LG))
        self.label_stackPlanSummary.setWordWrap(True)

        self.verticalLayout_14.addWidget(self.label_stackPlanSummary)

        self.verticalSpacer_9 = QSpacerItem(_s.LG + _s.XS, 1, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        ...
        self.widget_adaptiveAutofocusFields.setVisible(True)
        ...
        self.gridLayout_focusFields.addWidget(self.widget_adaptiveAutofocusFields, 0, 0, 1, 4)
        ...
        self.gridLayout_focusFields.addWidget(self.label_autofocusStatus, 1, 0, 1, 4)
        ...
        self.gridLayout_focusFields.addWidget(self.label_autofocusHint, 2, 0, 1, 4)
        ...
        self.gridLayout_focusFields.addWidget(self.progressBar_autofocus, 3, 0, 1, 4)
...
#if QT_CONFIG(tooltip)
        self.pushButton_acqPauseStack.setToolTip(QCoreApplication.translate("StackPanel", u"Pause cleanly at the next plane boundary. Lasers de-energize and the manifest is written as paused.", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(accessibility)
        self.pushButton_acqPauseStack.setAccessibleName(QCoreApplication.translate("StackPanel", u"Pause at Next Plane", None))
#endif // QT_CONFIG(accessibility)
        self.pushButton_acqPauseStack.setText(QCoreApplication.translate("StackPanel", u"Pause", None))
#if QT_CONFIG(tooltip)
