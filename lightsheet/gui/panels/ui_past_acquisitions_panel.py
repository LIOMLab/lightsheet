...
class Ui_PastAcquisitionsPanel(object):
    def setupUi(self, pastAcquisitionsPanel):
        ...
        self.tableWidget_pastAcquisitions.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.tableWidget_pastAcquisitions.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectRows)
        self.tableWidget_pastAcquisitions.setSelectionMode(QAbstractItemView.SelectionMode.SingleSelection)
