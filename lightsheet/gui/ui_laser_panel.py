...
#if QT_CONFIG(tooltip)
        self.checkBox_laserOneAutomatic.setToolTip(QCoreApplication.translate("LaserPanel", u"Auto on/off: when checked, Laser 1 is energized at the start of each acquisition and de-energized at the end. Safety: uncheck to keep the laser under manual toggle control.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.checkBox_laserTwoAutomatic.setToolTip(QCoreApplication.translate("LaserPanel", u"Auto on/off: when checked, Laser 2 is energized at the start of each acquisition and de-energized at the end. Safety: uncheck to keep the laser under manual toggle control.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.pushButton_laserOneToggle.setToolTip(QCoreApplication.translate("LaserPanel", u"Toggle Laser 1 emission on/off. Checkable: pressed-in = ON. Safety: the E-stop (F12) overrides this and drives the laser off immediately; a first-energize confirmation dialog appears once per session.", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.pushButton_laserTwoToggle.setToolTip(QCoreApplication.translate("LaserPanel", u"Toggle Laser 2 emission on/off. Checkable: pressed-in = ON. Safety: the E-stop (F12) overrides this and drives the laser off immediately; a first-energize confirmation dialog appears once per session.", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
