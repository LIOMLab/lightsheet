...
provided by **Frans Irgolitsch, Laboratoire d'Imagerie Optique et
Moléculaire, Polytechnique Montréal**. It is used here with permission
for testing the image viewer's contrast slider and levels bar in demo
mode (no hardware connected).
