...
if __name__ == '__main__':
    ...
    reset_time_ratio = 10               # [% of image time]
    ...
    # Computed experimental parameters (depends on settings above)
    
    # From PCO documentation
    ...
    samples_reset = int(np.ceil(samples_image * reset_time_ratio/100))
