...
def test_squarewave_shape() -> None:
    ...
    out = squarewave(pre_samples=5, active_samples=10, post_samples=5,
                     shift=0, repeat=2, inverted=False)
    assert out.shape == (40,)
...
def test_squarewave_dtype() -> None:
    ...
    out = squarewave(pre_samples=5, active_samples=10, post_samples=5,
                     shift=0, repeat=1, inverted=False)
...
def test_squarewave_inverted() -> None:
    ...
    out = squarewave(pre_samples=5, active_samples=10, post_samples=5,
                     shift=0, repeat=1, inverted=False)
    inv = squarewave(pre_samples=5, active_samples=10, post_samples=5,
                     shift=0, repeat=1, inverted=True)
...
def test_squarewave_shift_rotates_period() -> None:
    ...
    out = squarewave(pre_samples=5, active_samples=10, post_samples=5,
                     shift=2, repeat=1, inverted=False)
...
def test_sawtooth_shape() -> None:
    ...
    out = sawtooth(activated=True, pre_samples=5, trace_samples=10,
                   retrace_samples=5, post_samples=5, shift=0, repeat=2,
                   amplitude=1.0, offset=0.0, inverted=False, filtered=False)
    assert out.shape == (50,)
...
def test_sawtooth_dtype() -> None:
    ...
    out = sawtooth(activated=True, pre_samples=5, trace_samples=10,
                   retrace_samples=5, post_samples=5, shift=0, repeat=1,
                   amplitude=1.0, offset=0.0, inverted=False, filtered=False)
...
def test_sawtooth_deactivated_is_offset() -> None:
    ...
    out = sawtooth(activated=False, pre_samples=5, trace_samples=10,
                   retrace_samples=5, post_samples=5, shift=0, repeat=1,
                   amplitude=1.0, offset=0.5, inverted=False, filtered=False)
    assert out.shape == (25,)
...
def test_sawtooth_amplitude_offset_scaling() -> None:
    ...
    out = sawtooth(activated=True, pre_samples=5, trace_samples=10,
                   retrace_samples=5, post_samples=5, shift=0, repeat=1,
                   amplitude=2.0, offset=1.0, inverted=False, filtered=False)
...
def test_staircase_shape() -> None:
    ...
    out = staircase(activated=True, step_samples=10, nbr_steps=3, shift=0,
                    amplitude=2.0, offset=1.0, direction="up", filtered=False)
    assert out.shape == (30,)
...
def test_staircase_down_step_values() -> None:
    ...
    out = staircase(activated=True, step_samples=10, nbr_steps=3, shift=0,
                    amplitude=2.0, offset=1.0, direction="down", filtered=False)
...
def test_staircase_single_step_is_midlevel() -> None:
    ...
    out = staircase(activated=True, step_samples=10, nbr_steps=1, shift=0,
                    amplitude=2.0, offset=1.0, direction="up", filtered=False)
    assert out.shape == (10,)
...
def test_staircase_deactivated_is_offset() -> None:
    """activated=False returns a flat array at `offset`."""
    out = staircase(activated=False, step_samples=10, nbr_steps=3, shift=0,
                    amplitude=2.0, offset=1.0, direction="up", filtered=False)
    assert out.shape == (30,)
...
def test_squarewave_empty_period() -> None:
    ...
    out = squarewave(pre_samples=0, active_samples=0, post_samples=0,
                     shift=0, repeat=2, inverted=False)
    assert out.shape == (0,)
    assert out.dtype == np.bool_
...
def test_sawtooth_single_trace_sample() -> None:
    ...
    out = sawtooth(activated=True, pre_samples=0, trace_samples=1,
                   retrace_samples=1, post_samples=0, shift=0, repeat=1,
                   amplitude=1.0, offset=0.0, inverted=False, filtered=False)
    assert out.shape == (2,)
