...
def test_load_focus_curve_returns_valid_focus_curve(tmp_path) -> None:
...
def test_load_focus_curve_rejects_malformed_json(tmp_path) -> None:
...
def test_load_focus_curve_rejects_short_points(tmp_path) -> None:
...
def test_load_focus_curve_rejects_out_of_range_camera_position(tmp_path) -> None:
...
def test_load_focus_curve_rejects_missing_points(tmp_path) -> None:
...
def test_load_focus_curve_rejects_non_numeric_entries(tmp_path) -> None:
