...
def test_save_format_changed_zarr(qtbot: QtBot, request: Any) -> None:
...
def test_save_format_changed_both(qtbot: QtBot, request: Any) -> None:
...
def test_save_format_changed_hdf5(qtbot: QtBot, request: Any) -> None:
